...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/24b816fa2b7025a7192910a635992334-69.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/24b816fa2b7025a7192910a635992334-69.php"> <title>GtkAda contributions v3.9 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-69" class="blog-entry"><h1 class="blog-entry-title">GtkAda contributions v3.9</h1><div class="blog-entry-date">2022-04-17 Filed in: <span class="blog-entry-category"><a href="category-framework.php">Framework</a></span></div><div class="blog-entry-summary"><br />Changes to the version 3.29 :<br /><br /><ul class="disc"><li>Compatibility functions Get_Iter_At_Location and Get_Iter_At_Position were added to the package Gtk.Missed. </li><li>The functions provide backward compatibility to GTK 3.14 to 3.19 when the GTK interface was changed. </li><li>The implementation works with both earlier and later versions.</li></ul><br />Changes to this version 5.15 : <br /><br /><ul class="disc"><li>GNAT Studio Community 2021 bugs worked around; </li><li>GTK 3.24.x support</li></ul><br /><br />See <a href="http://www.dmitry-kazakov.de/ada/gtkada_contributions.htm" target="_blank" title="GtkAda contributions">Dmitry&rsquo;s Web page</a> for details<br /><br />Download from <a href="https://sourceforge.net/projects/gtkadacontributions/files/latest/download " target="_blank" title="GtkAda contributions">SourceForge</a><br />Download source <a href="http://www.dmitry-kazakov.de/ada/gtkada_contributions_3_30.tgz" target="_blank" title="gtkada_contributions_3_30.tgz" download="http://www.dmitry-kazakov.de/ada/gtkada_contributions_3_30.tgz">gtkada_contributions_3_30.tgz</a> from <a href="http://www.dmitry-kazakov.de/ada/gtkada_contributions.htm" target="_blank" title="GtkAda contributions">Dmitry&rsquo;s Web</a><br /><br /><br /><br />&copy; dmitry-kazakov<br />GPL-2.0-or-later<br /><br /><br /></div><div class="blog-entry-body"><br />The described here packages are proposed as a contribution to GtkAda, an Ada bindings to GTK+. <br /><br />It deals with the following issues:<br /><br /><ul class="disc"><li>Tasking support;</li><li>Custom models for tree view widget;</li><li>Custom cell renderers for tree view widget;</li><li>Multi-columned derived model;</li><li>Extension derived model (to add columns to an existing model);</li><li>Abstract caching model for directory-like data;</li><li>Tree view and list view widgets for navigational browsing of abstract caching models;</li><li>File system navigation widgets with wildcard filtering;</li><li>Resource styles;</li><li>Capturing resources of a widget;</li><li>Embeddable images;</li><li>Some missing subprograms and bug fixes;</li><li>Measurement unit selection widget and dialogs;</li><li>Improved hue-luminance-saturation color model;</li><li>Simplified image buttons and buttons customizable by style properties;</li><li>Controlled Ada types for GTK+ strong and weak references;</li><li>Simplified means to create lists of strings;</li><li>Spawning processes synchronously and asynchronously with pipes;</li><li>Capturing asynchronous process standard I/O by Ada tasks and by text buffers;</li><li>Source view widget support;</li><li>SVG images support.</li></ul><p class="blog-entry-tags">Tags: <a href="tag-gtk.php" title="GTK" rel="tag">GTK</a></p></div></div>
	</div>
