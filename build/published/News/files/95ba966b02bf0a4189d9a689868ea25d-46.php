...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/95ba966b02bf0a4189d9a689868ea25d-46.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/95ba966b02bf0a4189d9a689868ea25d-46.php"> <title>Ada PDF Writer v.002 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-46" class="blog-entry"><h1 class="blog-entry-title">Ada PDF Writer v.002</h1><div class="blog-entry-date">2016-04-25 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">Latest changes are:<br /><ul class="disc"><li>ISO Latin-1 character support</li><li>Image dimensions can be queried (useful before inserting them!)</li><li>Added tool: img2pdf</li><li>Improved demo - vector graphics with the Ada Mascot!</li><li>Some fixes</li></ul><br />http://apdf.sourceforge.net/<br /><br />From <a href="http://sf.net/users/gdemont/" rel="external">Gautier's Ada programming</a><br /><br /></div><div class="blog-entry-body"><p class="blog-entry-tags">Tags: <a href="tag-pdf.php" title="PDF" rel="tag">PDF</a></p></div></div>
	</div>
