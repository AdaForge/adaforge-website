...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/3fe9b600b2b7c8081ea709cade41d1f1-43.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/3fe9b600b2b7c8081ea709cade41d1f1-43.php"> <title>Adequate, MQTT broker and client programs based on Kasakov's Components | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-43" class="blog-entry"><h1 class="blog-entry-title">Adequate, MQTT broker and client programs based on Kasakov's Components</h1><div class="blog-entry-date">2016-05-31 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">The Adequate project provides command line clients for the MQTT protocol. All the hard work is provided by Dmitry Kazakov's Components. <br />Among them is an implementation of the MQTT protocol.<br /><br />The Adequate project consists of three programs<br /><ol class="arabic-numbers"><li>aq_broker, a MQTT broker or MQTT server.</li><li>aq_pub, a MQTT client for publishing single messages with a command line interface.</li><li>aq_sub, a MQTT client for subscribing to a topic (including wildcards). It also only has a command line interface.</li></ol><br /><a href="https://github.com/RREE/adequate">https://github.com/RREE/adequate</a><br /><br />From Rolf Ebert</div><div class="blog-entry-body">All programs are still in their infancy. They should help you getting started with Dmitry's code.<br /><br />If you want to direct the future development of Adequate I encourage you to create <a href="https://github.com/RREE/adequate/issues" rel="external">Issues</a><br />I also welcome adding and extending the <a href="https://github.com/RREE/adequate/wiki" rel="external">wiki pages</a> or Pull Requests.<br /><br /><p class="blog-entry-tags">Tags: <a href="tag-mqtt.php" title="MQTT" rel="tag">MQTT</a></p></div></div>
	</div>
