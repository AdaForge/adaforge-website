...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/41ab411ee45f251949716e78f04b58e6-28.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/41ab411ee45f251949716e78f04b58e6-28.php"> <title>Thick bindings for the Linux joystick API | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-28" class="blog-entry"><h1 class="blog-entry-title">Thick bindings for the Linux joystick API</h1><div class="blog-entry-date">2016-10-03 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">Thick bindings for the Linux joystick API are available at: <a href="https://github.com/alkhimey/Ada_Joystick">https://github.com/alkhimey/Ada_Joystick</a> <br /><br />From <a href="mailto:artium@nihamkin.com">Artium</a><br /><br /></div><div class="blog-entry-body">The highlight are typed axes/buttons:<br /><br /><code>type Logiteck_Extreme_3D_Pro_Axis_Type is      (STICK_X, STICK_Y, STICK_Z, THROTTLE, HAT_X, HAT_Y);type Logiteck_Extreme_3D_Pro_Button_Type is       (BUTTON_01, BUTTON_02, BUTTON_03, BUTTON_04,       BUTTON_05, BUTTON_06, BUTTON_07, BUTTON_08,       BUTTON_09, BUTTON_10, BUTTON_11, BUTTON_12);</code><br />   <br /><code>package L3D is new Linux_Joystick(Button_Type => Logiteck_Extreme_3D_Pro_Button_Type,                                     Axis_Type   => Logiteck_Extreme_3D_Pro_Axis_Type);</code><br /><br />I wrote this as an exercise, no specific use cases in mind. <br /><br />If you are developing graphic application, the framework you use (GLUT, GLFW etc.) might already have joystick input functionality that is cross platform.<br /><br />From <a href="mailto:artium@nihamkin.com">Artium</a></div></div>
	</div>
