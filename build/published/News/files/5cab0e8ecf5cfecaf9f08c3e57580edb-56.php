...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/5cab0e8ecf5cfecaf9f08c3e57580edb-56.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/5cab0e8ecf5cfecaf9f08c3e57580edb-56.php"> <title>HAC v.0.0996 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-56" class="blog-entry"><h1 class="blog-entry-title">HAC v.0.0996</h1><div class="blog-entry-date">2022-01-22 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-summary">HAC (HAC Ada Compiler) is a small, quick, open-source Ada compiler, covering a subset of the Ada language.<br /><br />HAC is itself fully programmed in Ada.<br /><br />Main improvements since v.0.095:<br /><ul class="disc"><li>range checks on discrete subtype assignment (:=) and conversion</li><li>short-circuit logical operators: "and then", "or else"</li><li>for S = Scalar subtype: S'First, S'Last, S'Succ, S'Pred, S'Pos, S'Val, S'Image, S'Value, S'Range attributes</li><li>for A = array object or array subtype: A'First [(N)], A'Last [(N)], A'Range [(N)], A'Length [(N)] attributes</li><li>"&", "<", ">", "=", "/=" operators defined for the String type (additionally to HAL.VString type)</li><li>CASE choices admit ranges</li><li>forward declarations for subprograms</li></ul></div><div class="blog-entry-body">Web site: http://hacadacompiler.sf.net/<br /><br />Source repositories:<br />#1 <a href="https://sf.net/p/hacadacompiler/code/HEAD/tree/trunk/" target="_blank">svn on SourceForge</a> <br />#2 <a href="https://github.com/zertovitch/hac" target="_blank">git on Github</a><br /><br />PS: for Windows, <a href="http://l-e-a.sf.net" target="_blank">LEA</a> is an integrated editor that embeds HAC.<br /><br />&copy; Gautier de Montmollin</div></div>
	</div>
