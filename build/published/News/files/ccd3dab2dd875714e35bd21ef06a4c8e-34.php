...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/ccd3dab2dd875714e35bd21ef06a4c8e-34.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/ccd3dab2dd875714e35bd21ef06a4c8e-34.php"> <title>GNAT for FreeBSD/64 available (two options) | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-34" class="blog-entry"><h1 class="blog-entry-title">GNAT for FreeBSD/64 available (two options)</h1><div class="blog-entry-date">2017-02-08 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-summary">Now the entire FreeBSD Ports Ada framework is available on this soon-to-be-tier-1 platform.  The existing gcc6-aux port (http://www.freshports.org/lang/gcc6-aux) was expanded to support aarch64.<br /><ul class="disc"><li>It passes the complete testsuite.  </li><li>That required providing a freebsd-specific signal frame unwinder which I'm passing back to GCC.</li><li>Results: <a href="http://www.dragonlace.net/gnataux/freebsd_arm64/">http://www.dragonlace.net/gnataux/freebsd_arm64/</a></li></ul>From John R. Marino<br /></div><div class="blog-entry-body"><ul class="disc"><li>If anybody is interested in Ada on the 64-bit ARMv8 architecture, there are a couple more options available to you today.</li><li>Last week I created a FreeBSD/DragonFly to FreeBSD64/ARM cross-compiler and placed it in ports: http://www.freshports.org/lang/gnatcross-aarch64/</li><li>That compiler was based on previous GnatDroid work.</li><li>Over the weekend, I used that cross-compiler to fully bootstrap FSF GCC 6.3.1 to FreeBSD/ARM64.  </li></ul><ul class="disc"><li>I also mentioned this news on my mostly neglected website: <a href="http://www.dragonlace.net/">http://www.dragonlace.net/</a></li><li>Hopefully somebody finds this work useful!.</li><li>John</li></ul><p class="blog-entry-tags">Tags: <a href="tag-arm.php" title="ARM" rel="tag">ARM</a>,<a href="tag-freebsd.php" title="FreeBSD" rel="tag">FreeBSD</a></p></div></div>
	</div>
