...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:title" content="Windows | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/tag-windows.php">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Ada Forge - Home">
	<meta property="og:title" content="Windows | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/tag-windows.php"> <title>Windows | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-headings-wrapper">
		<div class="blog-archive-month">Windows</div>
...
<div id="unique-entry-id-57" class="blog-entry"><h1 class="blog-entry-title"><a href="000e18e216f8213c9251df498cc74bdd-57.php" class="blog-permalink">Dokan Ada bindings 2.0</a></h1><div class="blog-entry-date">2022-01-16 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-body"><a href="https://github.com/dokan-dev/dokany/" target="_blank">Dokan</a> is a Windows 32- and 64-bit user-space file system, similar to FUSE.<br />Dokan is implemented in  in C/C++.<br />The driver routes the I/O requests to the file system device to the library callback. <br /><br />Changes to the <a href="http://www.dmitry-kazakov.de/ada/dokan.htm" target="_blank">Dokan Ada bindings</a> : <br /><ul class="disc"><li>The <a href="http://www.dmitry-kazakov.de/ada/dokan.htm" target="_blank">code and the Ada API</a> was reworked to accommodate the Dokan major version 2.</li></ul><br /><span class="blog-read-more"><a href="000e18e216f8213c9251df498cc74bdd-57.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-windows.php" title="Windows" rel="tag">Windows</a></p></div></div>
<div id="unique-entry-id-54" class="blog-entry"><h1 class="blog-entry-title"><a href="7a4ac44684893632ee14e6b0587c3c64-54.php" class="blog-permalink">GWindows release v2022-01-29</a></h1><div class="blog-entry-date">2022-01-29 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span><span class="blog-entry-category"> | <a href="category-tool.php">Tool</a></span><span class="blog-entry-category"> | <a href="category-framework.php">Framework</a></span></div><div class="blog-entry-body">GWindows is a full Microsoft Windows <strong>Rapid Application Development</strong> framework for programming GUIs (Graphical User Interfaces) with Ada. <br /><br />GWindows works only with the GNAT development system, but with some effort, GWindows could be made pure Ada. <br />GWindows is free and open-source! <br /><br />Changes to the framework are detailed in <a href="https://sourceforge.net/p/gnavi/code/HEAD/tree/gwindows/changes.txt" target="_blank">gwindows/changes.txt</a> or in the News forum on the <a href="https://sourceforge.net/projects/gnavi/" target="_blank">project site</a>. <br /><br /><span class="blog-read-more"><a href="7a4ac44684893632ee14e6b0587c3c64-54.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-windows.php" title="Windows" rel="tag">Windows</a></p></div></div>
	</div>
