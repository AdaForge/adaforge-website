...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/2a4707c79cc8b4d023f1bf15b884689a-42.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/2a4707c79cc8b4d023f1bf15b884689a-42.php"> <title>AZip v.2.0 released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-42" class="blog-entry"><h1 class="blog-entry-title">AZip v.2.0 released</h1><div class="blog-entry-date">2016-11-01 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">AZip is a Zip archive manager. <br /><br />The latest addition is an archive recompression tool.<br /><br /><a href="http://azip.sf.net/">http://azip.sf.net/</a><br /><br />From Gautier<br /></div><div class="blog-entry-body">Some features: <br /><ul class="disc"><li>Multi-document (should be familiar to MS Office users)</li><li>Flat view / Tree view</li><li>Simple to use (at least I hope so <img class="blog-image-smiley" src="../../rw_common/plugins/blog/smiley_wink.png" width="21" height="21" alt="Winking" border="0" /> ) </li><ul class="dashed"><li>Useful tools: </li><li>Text search function through an archive, without having to extract files </li><li>Archive updater </li><li>Integrity check </li><li>Archive recompression (new), using an algorithm-picking approach for improving a zip archive's compression.</li></ul></ul><ul class="disc"><li>Encryption</li><li>Methods supported: Reduce, Shrink, Implode, Deflate, Deflate64, BZip2, LZMA</li><li>Free, open-source</li><li>Portable (no installation needed, no DLL, no configuration file)</li></ul><br />"Under the hood" features:<br /><ul class="disc"><li>AZip is from A to Z in Ada <img class="blog-image-smiley" src="../../rw_common/plugins/blog/smiley_smile.png" width="21" height="21" alt="Happy" border="0" /> </li><li>Uses the highly portable Zip-Ada library </li><li>Portablity to various platforms: currently it's fully implemented with GWindows (for Windows), and there is a GtkAda draft, but anyway the key parts of the UI and user persistence are generic, platform-independent</li></ul><br />Enjoy!<br /><a href="http://gautiersblog.blogspot.com/search/label/Ada" rel="external">Gautier's Ada programming</a> <br /><p class="blog-entry-tags">Tags: <a href="tag-compression.php" title="Compression" rel="tag">Compression</a></p></div></div>
	</div>
