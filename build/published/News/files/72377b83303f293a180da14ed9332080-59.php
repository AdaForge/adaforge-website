...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/72377b83303f293a180da14ed9332080-59.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/72377b83303f293a180da14ed9332080-59.php"> <title>AdaControl v1.22r16c | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-59" class="blog-entry"><h1 class="blog-entry-title">AdaControl v1.22r16c</h1><div class="blog-entry-date">2021-12-07 Filed in: <span class="blog-entry-category"><a href="category-tool.php">Tool</a></span></div><div class="blog-entry-summary"><br />AdaControl is a free (GMGPL) tool that detects the use of various kinds of constructs in Ada programs. <br /><br />Its first goal is to control proper usage of style or programming rules, but it can also be used as a powerful tool to search for use (or non-use) of various forms of programming styles or design patterns. <br />Searched elements range from very simple, like the occurrence of certaine entities, declarations, or statements, to very sophisticated, like verifying that certain programming patterns are being obeyed.<br /><br /><a href="https://www.adalog.fr/en/adacontrol.html" target="_blank">AdaControl 1.22r16c</a> is mainly a bug fix release (no new rule), but improvements in the static evaluator provides better results and avoids <br />false positives in several rules. <br /><br />&copy; J-P. Rosen</div><div class="blog-entry-body"><br />AdaControl is a command line tool, but it has been fully integrated into AdaCore's GPS environment. From GPS, you can run AdaControl, fix the violations, or edit the rules file with just a few clicks.<p class="blog-entry-tags">Tags: <a href="tag-ada-style.php" title="Ada Style" rel="tag">Ada Style</a>,<a href="tag-quality-code.php" title="Quality Code" rel="tag">Quality Code</a></p></div></div>
	</div>
