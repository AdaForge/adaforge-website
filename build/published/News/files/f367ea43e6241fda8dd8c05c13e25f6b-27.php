...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/f367ea43e6241fda8dd8c05c13e25f6b-27.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/f367ea43e6241fda8dd8c05c13e25f6b-27.php"> <title>Thick bindings for Zstd v0.8 released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-27" class="blog-entry"><h1 class="blog-entry-title">Thick bindings for Zstd v0.8 released</h1><div class="blog-entry-date">2016-08-04 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">I created a set of thick bindings against the recent v0.8.0 version.  Those cover the stable API (basic compression / decompression and use of dictionaries). The API for streaming compression / decompression is not yet stable, and as such it is only available in the static library.  Once streaming de/compression is provided in the shared library, <br /><br /><a href="https://github.com/jrmarino/zstd-ada">https://github.com/jrmarino/zstd-ada</a><br /><br />From John R. Marino</div><div class="blog-entry-body">Zstandard is a real-time compression algorithm whose compression level settings provide a wide range between speed and size.  At the default settings, it compresses more and faster than gzip and at the other extreme it approaches the compression effectiveness of lzma but in a fraction of the time.<br /><br /><br /><a href="http://www.zstd.net">http://www.zstd.net</a><br /><a href="http://cyan4973.github.io/zstd/">http://cyan4973.github.io/zstd/</a><br /><p class="blog-entry-tags">Tags: <a href="tag-compression.php" title="Compression" rel="tag">Compression</a></p></div></div>
	</div>
