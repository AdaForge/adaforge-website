...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/050563826252ae469020fe1edba30efd-39.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/050563826252ae469020fe1edba30efd-39.php"> <title>Dequesterity v1.5 released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-39" class="blog-entry"><h1 class="blog-entry-title">Dequesterity v1.5 released</h1><div class="blog-entry-date">2016-04-22 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">(Buffers of many shapes and sizes)<br /><br />Dequesterity is a set of Ada 2005 generics that provide various forms of general purpose buffer containers.<br />Buffers may be used as deques, queues, ring buffers, stacks, double ended stacks, vectors, priority queues, and similar abstractions. <br /><br />There are various concurrent buffers, priority buffers, streaming buffers, remote buffers. In fact there are now over 100 buffer packages to choose from. <br /><br />This release mostly fixes some issues with the streaming Ravenscar buffers.<br /><a href="https://sourceforge.net/projects/dequesterity/files/">https://sourceforge.net/projects/dequesterity/files/</a> <br /><br />Brad Moore<br /><br /></div><div class="blog-entry-body">Thanks to Daniel for alerting me to the fact that the Ravenscar examples were no longer compiling.<br />Those examples were no longer compiling with the GNAT GPL 2015 version of the compiler. The compilations were failing due to violations of the Ravenscar<br />restrictions, No_Protected_Type_Allocators and No_Local_Protected_Objects.<br /><br />I believe these are valid restrictions that just were not being caught in earlier versions of the compiler. The problem is that the Stream Buffer has an<br />internal record component that is an internal buffer implemented as a protected type.<br /><br />To address these restrictions, I had to pull out the internal buffer declaration, and instead have the programmer declare this separately, then on the Stream Buffer declaration, have the programmer reference the "internal" buffer via an access discriminant.<br /><br /><br /><p class="blog-entry-tags">Tags: <a href="tag-buffers.php" title="Buffers" rel="tag">Buffers</a></p></div></div>
	</div>
