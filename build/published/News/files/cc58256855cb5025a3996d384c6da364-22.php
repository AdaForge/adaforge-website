...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/cc58256855cb5025a3996d384c6da364-22.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/cc58256855cb5025a3996d384c6da364-22.php"> <title>Ada Industrial Control Widget Library v3.13 released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-22" class="blog-entry"><h1 class="blog-entry-title">Ada Industrial Control Widget Library v3.13 released</h1><div class="blog-entry-date">2016-03-04 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span><span class="blog-entry-category"> | <a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">Changes to the previous version:<br /><ul class="disc"><li>Minor changes improving performance;</li><li>Waveform sweeper interface is enhanced to suppress the "draw" signal flood when a sweeper is shared by several independent widgets.</li></ul><br />Library can be found <a href="http://www.dmitry-kazakov.de/ada/aicwl.htm" rel="external">here</a>.<br />GNU GPL v2+ license (modified for runtime).<br /><br />Author Dmitry A. Kazakov<br /></div><div class="blog-entry-body">The software is based on GtkAda, Ada bindings to GTK+ and cairo.<br />The key features of the library:<br /><ul class="disc"><li>Widgets composed of transparent layers drawn by cairo;</li><li>Fully scalable graphics;</li><li>Support of time controlled refresh policy for real-time and heavy-duty applications;</li><li>Caching graphical operations;</li><li>Stream I/O support for serialization and deserialization;</li><li>Ready-to-use gauge, meter, oscilloscope widgets;</li><li>Editor widget for WYSIWYG design of complex dashboards.</li></ul><p class="blog-entry-tags">Tags: <a href="tag-widgets.php" title="Widgets" rel="tag">Widgets</a>,<a href="tag-gtk.php" title="GTK" rel="tag">GTK</a>,<a href="tag-industrial.php" title="Industrial" rel="tag">Industrial</a>,<a href="tag-gauge.php" title="Gauge" rel="tag">Gauge</a>,<a href="tag-dashboard.php" title="Dashboard" rel="tag">Dashboard</a></p></div></div>
	</div>
