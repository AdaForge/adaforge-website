...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/72d029dd42d1dda293ced93099b935db-15.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/72d029dd42d1dda293ced93099b935db-15.php"> <title>Muen microkernel 0.7 relesaed | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-15" class="blog-entry"><h1 class="blog-entry-title">Muen microkernel 0.7 relesaed</h1><div class="blog-entry-date">2016-02-22 Filed in: <span class="blog-entry-category"><a href="category-framework.php">Framework</a></span></div><div class="blog-entry-summary">The <a href="http://muen.codelabs.ch/" rel="external">Muen Separation Kernel</a> is the world&rsquo;s first Open Source microkernel that has been formally proven to contain no runtime errors at the source code level. It is developed in Switzerland by the Institute for Internet Technologies and Applications (ITA) at the University of Applied Sciences Rapperswil (HSR).<br /><br />The following major features and improvements have been implemented :<br /><ul class="disc"><li>Support for <a href="http://genode-labs.com/" rel="external">Genode VM</a> subjects</li><li>Subject time mechanism</li><li>Hardware and platform policy abstractions</li><li>Linux virtual filesystem and network interface drivers</li></ul></div><div class="blog-entry-body">The Muen platform includes re-usable components which implement common services:<br /><ul class="disc"><li>Subject Monitor (SM) written in SPARK 2014</li><li>Timeserver subject written in SPARK 2014</li><li>Debugserver subject written in Ada 2012</li><li>Virtual Terminal (VT) subject written in Ada 2012</li></ul><br />Furthermore the [muenfs] and [muennet] Linux kernel modules provide virtual filesystem and network interface drivers based on inter-subject memory channels.<br /><br />Ref : http://muen.codelabs.ch/<br />Ref : http://genode-labs.com/<p class="blog-entry-tags">Tags: <a href="tag-linux.php" title="Linux" rel="tag">Linux</a>,<a href="tag-spark.php" title="SPARK" rel="tag">SPARK</a></p></div></div>
	</div>
