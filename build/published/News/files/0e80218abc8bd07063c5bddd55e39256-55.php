...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/0e80218abc8bd07063c5bddd55e39256-55.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/0e80218abc8bd07063c5bddd55e39256-55.php"> <title>QOI, the Quite OK Image Format, added to GID, the Generic Image Decoder | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-55" class="blog-entry"><h1 class="blog-entry-title">QOI, the Quite OK Image Format, added to GID, the Generic Image Decoder</h1><div class="blog-entry-date">2022-02-28 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span></div><div class="blog-entry-summary"><br /><strong>QOI</strong> (the &laquo;<a href="https://github.com/phoboslab/qoi" target="_blank">Quite OK Image Format</a>&raquo; ) has been added to the add it to <strong>GID</strong>, the &laquo;<a href="https://gen-img-dec.sourceforge.io" target="_blank">Generic Image Decoder</a>&raquo; <span style="font:12px AppleColorEmoji; "><br /></span><span style="font:12px AppleColorEmoji; "><br /></span>GID is free, open-source, available on <a href="https://sourceforge.net/p/gen-img-dec/code/HEAD/tree/" target="_blank">SourceForge</a> and <a href="https://github.com/zertovitch/gid" target="_blank">GitHub</a>.<br /></div><div class="blog-entry-body"><a href="https://qoiformat.org" target="_blank">QOI</a> is a very simple raster image format C library with a decent lossless compression and an extremely good performance - a direct consequence of its simplicity and its compression features.<br /><br />It was clear from the first sight on that format that it was urgent to add it to GID (Ada). <br /><br />The Generic Image Decoder (GID) is an Ada package for decoding a broad variety of image formats, from any data stream, to any kind of medium, be it an in-memory bitmap, a GUI object, some other stream, floating-point data for scientific calculations, a browser element, a device,... Animations are supported.<br /><br />Some features:<br /><ul class="disc"><li>Task safe</li><li>Endian-neutral</li><li>Multi-platform, but native code build</li><li>Standalone (no dependency on other libraires, bindings, etc.; no extra component needed for running)</li><li>Unconditionally portable code: OS-, CPU-, compiler-independent code (*).</li><li>Pure Ada 2005: this package can be used in projects in Ada 2005, Ada 2012 and later language versions</li><li>Free, open-source</li></ul><br />(*) within limits of compiler's provided integer types and target architecture capacity. <br /><br />Some existing or possible applications:<br /><ul class="disc"><li>Image processing (interactive or not)</li><li>Image analysis, text recognition</li><li>A drawing program</li><li>A web browser</li><li>Use of images as data for scientific simulations</li><li>Thumbnail generation for a file manager</li><li>Conversion of compressed pictures to raw bitmaps for a user interface</li></ul><br />Currently supported formats are: BMP, GIF, JPEG, PNG, PNM (PBM, PGM, PPM), TGA<br /><br />&copy; Gautier de Montmollin<p class="blog-entry-tags">Tags: <a href="tag-image.php" title="Image" rel="tag">Image</a></p></div></div>
	</div>
