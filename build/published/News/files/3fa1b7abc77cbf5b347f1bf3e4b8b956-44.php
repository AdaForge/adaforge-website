...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/3fa1b7abc77cbf5b347f1bf3e4b8b956-44.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/3fa1b7abc77cbf5b347f1bf3e4b8b956-44.php"> <title>AdaBase 3.1 - includes Spatial data / Geographic object support | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-44" class="blog-entry"><h1 class="blog-entry-title">AdaBase 3.1 - includes Spatial data / Geographic object support</h1><div class="blog-entry-date">2016-06-16 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span></div><div class="blog-entry-summary">I had intended that release 3.1 of AdaBase be a quick improvement that would add three new native data types:<br /><ol class="arabic-numbers"><li>Bit type (like bit flags)</li><li>UTF8 encoded strings</li><li>Spatial data types / OpenGIS Geometry</li></ol><br /><a href="https://github.com/jrmarino/AdaBase">https://github.com/jrmarino/AdaBase</a><br /><br />From John R. Marino<br /></div><div class="blog-entry-body">The first two were relatively straight-forward.  <br /><br />Bits were sort of already supported but inconsistently and sometimes as strings.  Now they are an array of bits for easy manipulation.<br /><br />AdaBase tries to be smart with regard to encoding.<br />It forces the server to send text strings encoded as UTF8 and stores it natively and decodes them to strings/w/ws/ as necesary.<br /><br />The support for MySQL spatial data types and the PostGIS extension for PostgreSQL took far longer than I anticipated.  The result is pretty good,<br />I think, it allows AdaBase to directly query geometry fields without the use of database server-side functions to convert and extract.  It reads the<br />internal format of MySQL and PostGIS directly and converts them to Well Known Binary (WKB) which can be used to construct AdaBase Geometry objects and<br />also into Well Known Text.  This eliminates a lot of overhead as point data can be directly used immediately after a simple query that pulls<br />raw column data.<br /><br />I wrote a pretty l<a href="https://jrmarino.github.io/AdaBase/geometry.html" rel="external">og documentation</a> page with two separate test cases to show geometry data extraction and the geometry data construction and<br />insertion.  I don't know if anybody needs this feature, but I have a feeling there aren't a lot of database API packages that can handle GIS<br />data like this.<br /><p class="blog-entry-tags">Tags: <a href="tag-database.php" title="Database" rel="tag">Database</a>,<a href="tag-sql.php" title="SQL" rel="tag">SQL</a>,<a href="tag-postgresql.php" title="PostgreSQL" rel="tag">PostgreSQL</a>,<a href="tag-mysql.php" title="MySQL" rel="tag">MySQL</a>,<a href="tag-sqlite.php" title="SQLite" rel="tag">SQLite</a>,<a href="tag-spatial-data.php" title="Spatial data" rel="tag">Spatial data</a>,<a href="tag-opengis.php" title="OpenGIS" rel="tag">OpenGIS</a></p></div></div>
	</div>
