...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:title" content="Archives for July 2016 | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/archive-july-2016.php">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Ada Forge - Home">
	<meta property="og:title" content="Archives for July 2016 | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/archive-july-2016.php"> <title>Archives for July 2016 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-headings-wrapper">
		<div class="blog-archive-month">July 2016</div>
		<div class="blog-archive-link"><a href="../index.php">Programmer's Forge for Open Source Ada Code and Tools - News</a> | <a href="archive-august-2016.php">August 2016</a> | <a href="archive-june-2016.php">June 2016</a></div>
	</div>
	
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-29" class="blog-entry"><h1 class="blog-entry-title"><a href="f2b6994b600a888b2a44c66819108f8c-29.php" class="blog-permalink">Thick bindings for libsodium</a></h1><div class="blog-entry-date">2016-07-18 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-body">These bindings are thick and I've committed the testcases I was using to serve as examples.  They cover the most of the functionality of libsodium, but some are missing the thick counterparts (e.g. most of the detached versions have no thick counterpart as I stuck with the recommended "combined" variants).<br /><br /><a href="https://github.com/jrmarino/libsodium-ada">https://github.com/jrmarino/libsodium-ada</a><br /><br />From John R. Marino<br /><br /><span class="blog-read-more"><a href="f2b6994b600a888b2a44c66819108f8c-29.php"> Read More…</a></span></div></div><div id="unique-entry-id-36" class="blog-entry"><h1 class="blog-entry-title"><a href="14cbdcc085e5dc7f925e409a9b44e910-36.php" class="blog-permalink">GCC 6.1.0 native for OS X El Capitan, with GPL 2016 tools</a></h1><div class="blog-entry-date">2016-07-11 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-body">This is GCC 6.1.0 built for Mac OS X El Capitan (10.11.4, Darwin 15.4.0), with the Command Line Tools for Xcode 7.<br /><br />Compilers included: Ada, C, C++, Objective C, Objective C++, Fortran.<br /><br />gcc-6.1.0-x86_64-apple-darwin15-2016-bin.tar.bz2<br />at <a href="https://sourceforge.net/projects/gnuada/files/GNAT_GCC%20Mac%20OS%20X/6.1.0/native-2016/">https://sourceforge.net/projects/gnuada/files/GNAT_GCC%20Mac%20OS%20X/6.1.0/native-2016/</a><br /><br />From Simon Wright<br /><br /><span class="blog-read-more"><a href="14cbdcc085e5dc7f925e409a9b44e910-36.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-osx.php" title="OSX" rel="tag">OSX</a>,<a href="tag-macos.php" title="MacOS" rel="tag">MacOS</a></p></div></div><div id="unique-entry-id-35" class="blog-entry"><h1 class="blog-entry-title"><a href="092f01104d568e4f2d07a4a257c30da8-35.php" class="blog-permalink">GLOBE_3D Release 2016-07-05 - "Blender edition"</a></h1><div class="blog-entry-date">2016-07-09 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span></div><div class="blog-entry-body">GLOBE_3D is a GL Object Based 3D engine realized with the Ada programming language. <br /><br />Latest additions:<br /><ul class="disc"><li>Use of Generic Image Decoder (GID) in GL.IO; now most image formats are supported for textures and other bitmaps to be used with GLOBE_3D (or any GL app)</li><li>New Wavefront format (.obj / .mtl) importer</li><li>Doom 3 / Quake 4 map importer more complete</li><li>Unified GNAT project file (.gpr), allowing to selected the target Operating System (Windows, Linux, Mac) and compilation mode (fast, debug, small) for demos, tools, etc.</li><li>Project file for ObjectAda 9.1+ updated</li></ul><br /><a href="http://globe3d.sf.net">http://globe3d.sf.net</a> <br /><br />From:	<a href="mailto:gautier_niouzes@hotmail.com">gauthier</a><br />￼<br /><span class="blog-read-more"><a href="092f01104d568e4f2d07a4a257c30da8-35.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-3d.php" title="3D" rel="tag">3D</a></p></div></div>
	</div>
