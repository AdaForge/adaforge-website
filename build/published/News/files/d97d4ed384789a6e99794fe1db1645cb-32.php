...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/d97d4ed384789a6e99794fe1db1645cb-32.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/d97d4ed384789a6e99794fe1db1645cb-32.php"> <title>Imago 0.2 released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-32" class="blog-entry"><h1 class="blog-entry-title">Imago 0.2 released</h1><div class="blog-entry-date">2016-05-01 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">Imago is a thin binding to DevIL - Developers' Image Library (which is a library that supports working with most image formats). <br /><br /><a href="https://github.com/darkestkhan/imago/tree/0.2">https://github.com/darkestkhan/imago/tree/0.2</a><br /><br />From <a href="mailto:darkestkhan@gmail.com">darkestkhan</a><br /><br /></div><div class="blog-entry-body">It closely follows original API so for how information on how to use it I recommend looking at original library documentation and lazyfoo tutorials (and just happens so that I have repository on github with lazyfoo tutorials implemented in Ada: <a href="http://www.github.com/darkestkhan/lazyfoo">www.github.com/darkestkhan/lazyfoo</a> )<br /><br />From <a href="mailto:darkestkhan@gmail.com">darkestkhan</a><br /><p class="blog-entry-tags">Tags: <a href="tag-image.php" title="Image" rel="tag">Image</a></p></div></div>
	</div>
