...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/6ea470c775774350d81dfaa1c7da7c57-14.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/6ea470c775774350d81dfaa1c7da7c57-14.php"> <title>XNAdaLib 2015 binaries for MacOS 10.9 including GTKAda GPL 2015 and more | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-14" class="blog-entry"><h1 class="blog-entry-title">XNAdaLib 2015 binaries for MacOS 10.9 including GTKAda GPL 2015 and more</h1><div class="blog-entry-date">2015-09-03 Filed in: <span class="blog-entry-category"><a href="category-framework.php">Framework</a></span><span class="blog-entry-category"> | <a href="category-tool.php">Tool</a></span><span class="blog-entry-category"> | <a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary"><span style="font:14px .AppleSystemUIFont; ">This is XNAdaLib 2015 built on MacOS 10.9 Mavericks for Native Quartz including:<br /></span><ul class="disc"><li><span style="font:14px .AppleSystemUIFont; ">GTK Ada GPL 2015 with GTK+ 3.16.0 complete,</span></li><li><span style="font:14px .AppleSystemUIFont; ">Glade 3.18.3,</span></li><li><span style="font:14px .AppleSystemUIFont; ">GnatColl GPL 2015,</span></li><li><span style="font:14px .AppleSystemUIFont; ">Florist GPL 2015,</span></li><li><span style="font:14px .AppleSystemUIFont; ">AdaCurses 20110404,</span></li><li><span style="font:14px .AppleSystemUIFont; ">Gate 3-04-b,</span></li><li><span style="font:14px .AppleSystemUIFont; ">AICWL 3.11 (with Components 4.8 and gtksourceview 3.14.3),</span></li><li><span style="font:14px .AppleSystemUIFont; ">GNOGA 1.1a,</span></li></ul></div><div class="blog-entry-body"><span style="font:14px .AppleSystemUIFont; "><br />To be installed for instance at <br /></span><code>/usr/local</code><span style="font:14px .AppleSystemUIFont; "><br /></span><code>$ cd /usr/local$ sudo tar xzf xnadalib-gpl-2015-quartz-x86_64-apple-darwin13.4.0-bin.tgz</code><span style="font:14px .AppleSystemUIFont; "><br />Update your PATH to include gtkada-config, glade, gate3.sh and other executables in it:<br /></span><code>$ PATH=/usr/local/xadalib-2015/bin:$PATH</code><span style="font:14px .AppleSystemUIFont; "><br /><br />Update your GPR_PROJECT_PATH to include gtkada.gpr, adacurses.gpr, florist.gpr, gnatcoll.gpr, gnoga.gpr and other projects in it:<br /></span><code>$ export GPR_PROJECT_PATH=/usr/local/xnadalib-2015/lib/gnat:/usr/local/xnadalib-2015/share/gpr:$GPR_PROJECT_PATH</code><span style="font:14px .AppleSystemUIFont; ">Set XDG_DATA_DIRS for GNOME apps:<br /></span><code>$ export XDG_DATA_DIRS=/usr/local/xnadalib-2015/share</code><span style="font:14px .AppleSystemUIFont; "><br />Glade and GPS applications in apps directory must stay in this directory unless<br />you modify the script inside apps.<br /><br />Then see documentation and examples in share directory and enjoy.<br /><br />Here is the instructions I used to build XNAdaLib on MacOS:<br />(French language)<br /></span><span style="font:14px .AppleSystemUIFont; color:#0000FF;"><u><a href="http://blady.pagesperso-orange.fr/telechargements/gtkada/Install-GTKAda-Quartz_wf.pdf">http://blady.pagesperso-orange.fr/telechargements/gtkada/Install-GTKAda-Quartz_wf.pdf</a></u></span><span style="font:14px .AppleSystemUIFont; "><br /><br />Here is the modifications I made:<br /></span><span style="font:14px .AppleSystemUIFont; color:#0000FF;"><u><a href="http://blady.pagesperso-orange.fr/telechargements/gtkada/xadalib-2015-diff.tgz">http://blady.pagesperso-orange.fr/telechargements/gtkada/xadalib-2015-diff.tgz</a></u></span><span style="font:14px .AppleSystemUIFont; "><br /><br />XAdaLib binaries have been post on Source Forge:<br /></span><span style="font:14px .AppleSystemUIFont; color:#0000FF;"><u><a href="http://sourceforge.net/projects/gnuada/files/GNAT_GPL%20Mac%20OS%20X/2015-mavericks/">http://sourceforge.net/projects/gnuada/files/GNAT_GPL%20Mac%20OS%20X/2015-mavericks/</a></u></span><span style="font:14px .AppleSystemUIFont; "><br /><br />Feel free to send comments.<br /><br />Pascal "Blady" Pignard.<br /></span><p class="blog-entry-tags">Tags: <a href="tag-osx.php" title="OSX" rel="tag">OSX</a>,<a href="tag-quartz.php" title="Quartz" rel="tag">Quartz</a>,<a href="tag-gtk.php" title="GTK" rel="tag">GTK</a>,<a href="tag-gnat.php" title="GNAT" rel="tag">GNAT</a>,<a href="tag-macos.php" title="MacOS" rel="tag">MacOS</a></p></div></div>
	</div>
