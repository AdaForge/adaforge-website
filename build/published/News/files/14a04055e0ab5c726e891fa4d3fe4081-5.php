...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/14a04055e0ab5c726e891fa4d3fe4081-5.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/14a04055e0ab5c726e891fa4d3fe4081-5.php"> <title>Compare programming languages with the EEC Energy Label | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-5" class="blog-entry"><h1 class="blog-entry-title">Compare programming languages with the EEC Energy Label</h1><div class="blog-entry-date">2015-09-09 Filed in: <span class="blog-entry-category"><a href="category-humor.php">Humor</a></span></div><div class="blog-entry-summary">How does Ada 2012 compare to the most popular or modern programming languages ?<br /><ul class="disc"><li>C-Sharp 2015</li><li>Java 8</li></ul><ul class="disc"><li>JavaScript 5</li></ul><ul class="disc"><li>Scala 2.9</li></ul><ul class="disc"><li>Swift 2.1</li></ul><br />Evaluation in progress&hellip; <br /><br /><br /><br /></div><div class="blog-entry-body"><br /><br /><img class="imageStyle" alt="which-programs-are-fastest-20151029" src="which-programs-are-fastest-20151029.png" width="752" height="226" /><br />Source : <a href="http://benchmarksgame.alioth.debian.org/u64q/which-programs-are-fastest.html" rel="external">BenchmarksGame</a><br /><br /><br /><br />Find out the amount of <strong>k.SLOC/month</strong> one seasoned programmer can do with his favorite programming environment.<br />Condition : <strong>BUGFREE<br /></strong> <br />How many bugs /K.Sloc after a good compiler pass would there be on average ?<br /><br />(<u>note</u>: figures hereafter on the label are <strong>absolutely biased</strong> for our good sake )<br />Did you say '<em>another flame-war</em>' ?<br /><br /><img class="imageStyle" alt="EEC Label Ada 2012" src="eec-label-ada-2012-2.png" width="240" height="480" /><img class="imageStyle" alt="EEC Label Java 8" src="eec-label-java-8.png" width="240" height="480" /><img class="imageStyle" alt="EEC Label Swift 2.1" src="eec-label-swift-2.1.png" width="240" height="480" /><br />(EEC Label reworked from a nice idea of Yannick Moy)</div></div>
	</div>
