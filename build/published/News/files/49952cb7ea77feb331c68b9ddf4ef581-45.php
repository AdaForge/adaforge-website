...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/49952cb7ea77feb331c68b9ddf4ef581-45.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/49952cb7ea77feb331c68b9ddf4ef581-45.php"> <title>Ada/SPARK ASN.1 implementation version 0.0.01 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-45" class="blog-entry"><h1 class="blog-entry-title">Ada/SPARK ASN.1 implementation version 0.0.01</h1><div class="blog-entry-date">2016-08-01 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">I'm making public my ASN.1 project which aims to be a verified implementation of ASN.1, which is used in security-certificates, which is hopefully the first step in a verified-TLS/-TLS -- the project also aims to be [directly] usable in DSA projects.<br /><br />As of 0.0.01 the only portion implemented is a pure big-number package, and another currently shared-passive unit for usability. <br />I would certainly appropriate comments, criticism, and most especially contributions.<br /><br /><a href="https://github.com/OneWingedShark/ASN.1/">https://github.com/OneWingedShark/ASN.1/</a><br /><br />From Shark8<br /></div><div class="blog-entry-body"><p class="blog-entry-tags">Tags: <a href="tag-spark.php" title="SPARK" rel="tag">SPARK</a></p></div></div>
	</div>
