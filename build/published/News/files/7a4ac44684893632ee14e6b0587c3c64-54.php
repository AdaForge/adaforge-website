...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/7a4ac44684893632ee14e6b0587c3c64-54.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/7a4ac44684893632ee14e6b0587c3c64-54.php"> <title>GWindows release v2022-01-29 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-54" class="blog-entry"><h1 class="blog-entry-title">GWindows release v2022-01-29</h1><div class="blog-entry-date">2022-01-29 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span><span class="blog-entry-category"> | <a href="category-tool.php">Tool</a></span><span class="blog-entry-category"> | <a href="category-framework.php">Framework</a></span></div><div class="blog-entry-summary">GWindows is a full Microsoft Windows <strong>Rapid Application Development</strong> framework for programming GUIs (Graphical User Interfaces) with Ada. <br /><br />GWindows works only with the GNAT development system, but with some effort, GWindows could be made pure Ada. <br />GWindows is free and open-source! <br /><br />Changes to the framework are detailed in <a href="https://sourceforge.net/p/gnavi/code/HEAD/tree/gwindows/changes.txt" target="_blank">gwindows/changes.txt</a> or in the News forum on the <a href="https://sourceforge.net/projects/gnavi/" target="_blank">project site</a>. <br /><br /></div><div class="blog-entry-body">In a nutshell (since last announcement here): <br /><br />427: GWindows.Image_Lists: added color options; includes features of "extended" Ex_Image_List_Type in package GWindows.Image_Lists.Ex_Image_Lists, which is marked as obsolescent. <br />424: GWindows.Application: added function Screen_Visibility. <br />423: GWindows.Application: added Enumerate_Display_Monitors. <br />422: GWindows.Base: added Set_Foreground_Window. <br />421: GWindows.Base: added Set_Active_Window. <br />417: GWindows.Common_Controls.Ex_Tb (toolbar): is now 64-bit compatible; see LEA http://l-e-a.sf.net/ , LEA_GWin.Toolbars for an example. <br />414: GWindows.Scintilla: method names are "de-camel-cased": e.g.: "Move_Caret_Inside_View" instead of "MoveCaretInsideView". <br />412: GWindows.Scintilla: works on both Intel x86 32-bit and x64 64-bit types of platforms. <br />411: GWindows.Common_Controls.Ex_List_View: method On_Free_Payload is now public and can be overriden with effect. <br />410: GWindows.Common_Controls.Ex_List_View: Sort can use a comparison method not based on strings (e.g. a numerical comparison). <br /><br /><br />Ref <a href="https://sf.net/projects/gnavi/" target="_blank">GWindows Project site</a><br /><br />Ref <a href="https://github.com/zertovitch/gwindows " target="_blank">GWindows GitHub clone</a><br /><br />&copy; Gautier de Montmollin<br /><p class="blog-entry-tags">Tags: <a href="tag-windows.php" title="Windows" rel="tag">Windows</a></p></div></div>
	</div>
