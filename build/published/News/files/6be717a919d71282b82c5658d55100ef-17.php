...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/6be717a919d71282b82c5658d55100ef-17.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/6be717a919d71282b82c5658d55100ef-17.php"> <title>GCC 5.2.1 arm-eabi for OS X El Capitan | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-17" class="blog-entry"><h1 class="blog-entry-title">GCC 5.2.1 arm-eabi for OS X El Capitan</h1><div class="blog-entry-date">2016-01-26 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-summary"><ul class="disc"><li>This is GCC 5.2.1 for arm-eabi from GCC <a href="https://launchpad.net/gcc-arm-embedded" rel="external">ARM Launchpad</a>, tested on</li><li>the Cortex-M3 as found on the <a href="http://www.arduino.com" rel="external">Arduino Due</a> and the Cortex-M4 as</li><li>found on the STMicroelectronics STM32F4 Discovery and STM32F429I</li><li>Discovery boards.</li><li>Downloads on <a href="https://sourceforge.net/projects/gnuada/files/GNAT_GCC%20Mac%20OS%20X/5.2.0/arm-eabi/" rel="external">SourceForge</a>, prepared by <a href="https://sourceforge.net/u/simonjwright/profile/" rel="external">Simon Wright</a></li></ul></div><div class="blog-entry-body">The processors supported are Cortex-M3, Cortex-M4, Cortex-M0+, Cortex-M7, Cortex-R4, Cortex-R5 and Cortex-R7.<br /><br />The compiler comes with no Ada Runtime System (RTS). See the <a href="https://sourceforge.net/projects/cortex-gnat-rts/" rel="external">Cortex GNAT Run Time Systems</a> project for candidates.<br /><br />The compiler is known to run on El Capitan; it may not run on earlier OS X releases.<br /><p class="blog-entry-tags">Tags: <a href="tag-gcc.php" title="GCC" rel="tag">GCC</a>,<a href="tag-arm.php" title="ARM" rel="tag">ARM</a>,<a href="tag-arduino.php" title="Arduino" rel="tag">Arduino</a>,<a href="tag-cortex.php" title="Cortex" rel="tag">Cortex</a>,<a href="tag-osx.php" title="OSX" rel="tag">OSX</a></p></div></div>
	</div>
