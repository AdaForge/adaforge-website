...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/000e18e216f8213c9251df498cc74bdd-57.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/000e18e216f8213c9251df498cc74bdd-57.php"> <title>Dokan Ada bindings 2.0 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-57" class="blog-entry"><h1 class="blog-entry-title">Dokan Ada bindings 2.0</h1><div class="blog-entry-date">2022-01-16 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary"><a href="https://github.com/dokan-dev/dokany/" target="_blank">Dokan</a> is a Windows 32- and 64-bit user-space file system, similar to FUSE.<br />Dokan is implemented in  in C/C++.<br />The driver routes the I/O requests to the file system device to the library callback. <br /><br />Changes to the <a href="http://www.dmitry-kazakov.de/ada/dokan.htm" target="_blank">Dokan Ada bindings</a> : <br /><ul class="disc"><li>The <a href="http://www.dmitry-kazakov.de/ada/dokan.htm" target="_blank">code and the Ada API</a> was reworked to accommodate the Dokan major version 2.</li></ul><br /></div><div class="blog-entry-body">A sample implementing a memory resident files system is provided. <br /> <br />&copy; Dmitry A. Kazakov <br /><p class="blog-entry-tags">Tags: <a href="tag-windows.php" title="Windows" rel="tag">Windows</a></p></div></div>
	</div>
