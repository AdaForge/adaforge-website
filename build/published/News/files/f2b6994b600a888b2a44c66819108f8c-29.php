...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/f2b6994b600a888b2a44c66819108f8c-29.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/f2b6994b600a888b2a44c66819108f8c-29.php"> <title>Thick bindings for libsodium | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-29" class="blog-entry"><h1 class="blog-entry-title">Thick bindings for libsodium</h1><div class="blog-entry-date">2016-07-18 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">These bindings are thick and I've committed the testcases I was using to serve as examples.  They cover the most of the functionality of libsodium, but some are missing the thick counterparts (e.g. most of the detached versions have no thick counterpart as I stuck with the recommended "combined" variants).<br /><br /><a href="https://github.com/jrmarino/libsodium-ada">https://github.com/jrmarino/libsodium-ada</a><br /><br />From John R. Marino<br /><br /></div><div class="blog-entry-body"></div></div>
	</div>
