...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/3268b0cc9203a02f37a4a0c879f61182-52.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/3268b0cc9203a02f37a4a0c879f61182-52.php"> <title>UXStrings v2022-02-26 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-52" class="blog-entry"><h1 class="blog-entry-title">UXStrings v2022-02-26</h1><div class="blog-entry-date">2022-02-26 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span></div><div class="blog-entry-summary">The objective of UXStrings is Unicode and dynamic length support for <br />strings in Ada. <br /><br />Changes from last publication: <br /><ul class="disc"><li>Ada.Strings.UTF_Encoding.Conversions fix is no longer needed with GNAT CE 2021 </li><li>A few fix </li></ul><br /></div><div class="blog-entry-body">UXStrings API is inspired from Ada.Strings.Unbounded in order to <br />minimize adaptation work from existing Ada source codes. <br /><br />Available on <a href="https://github.com/Blady-Com/UXStrings" target="_blank">GitHub</a> and also on <a href="https://alire.ada.dev/crates/uxstrings.html" target="_blank">Alire</a>. <br /><br />&copy; Pascal Pignard [Blady]<p class="blog-entry-tags">Tags: <a href="tag-strings.php" title="Strings" rel="tag">Strings</a></p></div></div>
	</div>
