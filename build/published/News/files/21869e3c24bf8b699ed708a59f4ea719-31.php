...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/21869e3c24bf8b699ed708a59f4ea719-31.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/21869e3c24bf8b699ed708a59f4ea719-31.php"> <title>AdaBase - Thick database bindings for Ada | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-31" class="blog-entry"><h1 class="blog-entry-title">AdaBase - Thick database bindings for Ada</h1><div class="blog-entry-date">2016-05-30 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span></div><div class="blog-entry-summary">Hey guys, I know there are several options for Ada to interface with databases, but I wasn't happy with any of them for various reasons and thus created yet another option to scratch my itch.  I was aiming at a consistent interface to which the various drivers adapt.  With some care, the database backends should be interchangeable.<br /><br />So far I've created drivers for MySQL and SQLite and the driver for PostgreSQL is next on my list.  I'd like to eventually support others such as Firebird, MSSQL, Oracle, etc., but those will be very low priority for me over the next year.  Contributions are welcome of course -- It's been released under the developer- and commercial-friendly ISC licence.<br /><br /><br /><a href="http://jrmarino.github.io/AdaBase/">http://jrmarino.github.io/AdaBase/</a><br /><br />From <a href="mailto:dragonlace.cla@marino.st">John R. Marino</a><br /></div><div class="blog-entry-body"><br />I've spent a lot of time documenting the interface and providing a lot of real examples.  If you are at all looking for something like this, I recommend that you spend a few minutes going through the descriptions and examples of all the functions:<br /><br />It's been developed on DragonFly and FreeBSD, and I haven't tested it on Windows yet, but I will.  it's already available for BSD users, see: http://www.freshports.org/databases/adabase<br /><br />I believe AdaBase is already mature for MySQL and SQLite, but reports of issues will be welcome.  I'm active on github, so issues and pull requests will be dispositioned quickly if you wish to leverage those tools.<br /><br />Hopefully other people will find this project useful!<br /><br />--  John<br /><p class="blog-entry-tags">Tags: <a href="tag-database.php" title="Database" rel="tag">Database</a>,<a href="tag-sql.php" title="SQL" rel="tag">SQL</a>,<a href="tag-postgresql.php" title="PostgreSQL" rel="tag">PostgreSQL</a>,<a href="tag-mysql.php" title="MySQL" rel="tag">MySQL</a>,<a href="tag-sqlite.php" title="SQLite" rel="tag">SQLite</a></p></div></div>
	</div>
