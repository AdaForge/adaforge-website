...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/29d84545ce729f4cfc6916a0e0411242-8.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/29d84545ce729f4cfc6916a0e0411242-8.php"> <title>Qt5Ada version 5.5.0 released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-8" class="blog-entry"><h1 class="blog-entry-title">Qt5Ada version 5.5.0 released</h1><div class="blog-entry-date">2015-07-03 Filed in: <span class="blog-entry-category"><a href="category-framework.php">Framework</a></span></div><div class="blog-entry-summary"><span style="font:12px .AppleSystemUIFont; ">Qt5Ada is a Ada-2012 port to Qt5 framework (based on Qt 5.5.0 final)<br /><br />This project uses a proprietary layer. It is not completely open source. (Ref David Botton)</span></div><div class="blog-entry-body"><br /><span style="font:12px .AppleSystemUIFont; ">Qt5Ada for Windows, Linux (Unix)  and Mac (OSX) is available from<br /></span><span style="font:12px .AppleSystemUIFont; color:#0000FF;"><u><a href="https://drive.google.com/folderview?id=0B2QuZLoe-yiPbmNQRl83M1dTRVE&usp=sharing">https://drive.google.com/folderview?id=0B2QuZLoe-yiPbmNQRl83M1dTRVE&usp=sharing</a></u></span><span style="font:12px .AppleSystemUIFont; "> (google drive. It can be mounted as virtual drive or directory or viewed with Web Browser) or download from </span><span style="font:12px .AppleSystemUIFont; color:#0000FF;"><u><a href="http://ul.to/3u8uz26c">http://ul.to/3u8uz26c</a></u></span><p class="blog-entry-tags">Tags: <a href="tag-qt.php" title="QT" rel="tag">QT</a></p></div></div>
	</div>
