...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:title" content="Linux | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/tag-linux.php">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Ada Forge - Home">
	<meta property="og:title" content="Linux | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/tag-linux.php"> <title>Linux | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-headings-wrapper">
		<div class="blog-archive-month">Linux</div>
...
<div id="unique-entry-id-15" class="blog-entry"><h1 class="blog-entry-title"><a href="72d029dd42d1dda293ced93099b935db-15.php" class="blog-permalink">Muen microkernel 0.7 relesaed</a></h1><div class="blog-entry-date">2016-02-22 Filed in: <span class="blog-entry-category"><a href="category-framework.php">Framework</a></span></div><div class="blog-entry-body">The <a href="http://muen.codelabs.ch/" rel="external">Muen Separation Kernel</a> is the world&rsquo;s first Open Source microkernel that has been formally proven to contain no runtime errors at the source code level. It is developed in Switzerland by the Institute for Internet Technologies and Applications (ITA) at the University of Applied Sciences Rapperswil (HSR).<br /><br />The following major features and improvements have been implemented :<br /><ul class="disc"><li>Support for <a href="http://genode-labs.com/" rel="external">Genode VM</a> subjects</li><li>Subject time mechanism</li><li>Hardware and platform policy abstractions</li><li>Linux virtual filesystem and network interface drivers</li></ul><span class="blog-read-more"><a href="72d029dd42d1dda293ced93099b935db-15.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-linux.php" title="Linux" rel="tag">Linux</a>,<a href="tag-spark.php" title="SPARK" rel="tag">SPARK</a></p></div></div>
<div id="unique-entry-id-13" class="blog-entry"><h1 class="blog-entry-title"><a href="a5028fd379ccb7aee611e12b450c6fad-13.php" class="blog-permalink">Ada packages on Archlinux updated to GPL15</a></h1><div class="blog-entry-date">2015-07-28 Filed in: <span class="blog-entry-category"><a href="category-tool.php">Tool</a></span><span class="blog-entry-category"> | <a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-body"><span style="font:14px .AppleSystemUIFont; ">The new packages are on AUR4.<br /></span><span class="blog-read-more"><a href="a5028fd379ccb7aee611e12b450c6fad-13.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-linux.php" title="Linux" rel="tag">Linux</a></p></div></div>
	</div>
