...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-41" class="blog-entry"><h1 class="blog-entry-title"><a href="c40519cb7d7eeafad65faddfdf5c9b67-41.php" class="blog-permalink">GNAT RTS for CORTEX 20160522</a></h1><div class="blog-entry-date">2016-05-22 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-body">This release includes GNAT Ada Run Time Systems (RTSs) based on FreeRTOS (http://www.freertos.org) and targeted at boards with Cortex-M3, -M4, -M4F MCUs (<a href="http://www.arduino.org" rel="external">Arduino</a> Due, the STM32F4-series evaluation boards from <a href="http://www.st.com" rel="external">STMicroelectronics</a>.<br /><br />In this release,<br /><ul class="disc"><li>There is no longer any dependence on the STMicroelectronics'  STM32Cube package.</li><li>The support for on-chip peripherals is limited to the SVD2Ada-generated spec files. The AdaCore 'bareboard' software (currently https://github.com/AdaCore/bareboard, but a name change   is under consideration) supports the STM32 line.</li><li>Tasking no longer requires an explicit start (https://sourceforge.net/p/cortex-gnat-rts/tickets/5/).</li><li>Locking in interrupt-handling protected objects no longer inhibits all interrupts, only those of equal or lower priority (https://sourceforge.net/p/cortex-gnat-rts/tickets/18/).</li></ul><br /><a href="https://sourceforge.net/projects/cortex-gnat-rts/files/20160522/">https://sourceforge.net/projects/cortex-gnat-rts/files/20160522/</a><br /><br />From Simon Wright<br /><br /><span class="blog-read-more"><a href="c40519cb7d7eeafad65faddfdf5c9b67-41.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-rts.php" title="RTS" rel="tag">RTS</a>,<a href="tag--gnat.php" title=" GNAT" rel="tag"> GNAT</a></p></div></div>
	</div>
