...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:title" content="Archives for May 2016 | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/archive-may-2016.php">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Ada Forge - Home">
	<meta property="og:title" content="Archives for May 2016 | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/archive-may-2016.php"> <title>Archives for May 2016 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-headings-wrapper">
		<div class="blog-archive-month">May 2016</div>
		<div class="blog-archive-link"><a href="../index.php">Programmer's Forge for Open Source Ada Code and Tools - News</a> | <a href="archive-june-2016.php">June 2016</a> | <a href="archive-april-2016.php">April 2016</a></div>
	</div>
	
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-43" class="blog-entry"><h1 class="blog-entry-title"><a href="3fe9b600b2b7c8081ea709cade41d1f1-43.php" class="blog-permalink">Adequate, MQTT broker and client programs based on Kasakov's Components</a></h1><div class="blog-entry-date">2016-05-31 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-body">The Adequate project provides command line clients for the MQTT protocol. All the hard work is provided by Dmitry Kazakov's Components. <br />Among them is an implementation of the MQTT protocol.<br /><br />The Adequate project consists of three programs<br /><ol class="arabic-numbers"><li>aq_broker, a MQTT broker or MQTT server.</li><li>aq_pub, a MQTT client for publishing single messages with a command line interface.</li><li>aq_sub, a MQTT client for subscribing to a topic (including wildcards). It also only has a command line interface.</li></ol><br /><a href="https://github.com/RREE/adequate">https://github.com/RREE/adequate</a><br /><br />From Rolf Ebert<span class="blog-read-more"><a href="3fe9b600b2b7c8081ea709cade41d1f1-43.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-mqtt.php" title="MQTT" rel="tag">MQTT</a></p></div></div><div id="unique-entry-id-31" class="blog-entry"><h1 class="blog-entry-title"><a href="21869e3c24bf8b699ed708a59f4ea719-31.php" class="blog-permalink">AdaBase - Thick database bindings for Ada</a></h1><div class="blog-entry-date">2016-05-30 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span></div><div class="blog-entry-body">Hey guys, I know there are several options for Ada to interface with databases, but I wasn't happy with any of them for various reasons and thus created yet another option to scratch my itch.  I was aiming at a consistent interface to which the various drivers adapt.  With some care, the database backends should be interchangeable.<br /><br />So far I've created drivers for MySQL and SQLite and the driver for PostgreSQL is next on my list.  I'd like to eventually support others such as Firebird, MSSQL, Oracle, etc., but those will be very low priority for me over the next year.  Contributions are welcome of course -- It's been released under the developer- and commercial-friendly ISC licence.<br /><br /><br /><a href="http://jrmarino.github.io/AdaBase/">http://jrmarino.github.io/AdaBase/</a><br /><br />From <a href="mailto:dragonlace.cla@marino.st">John R. Marino</a><br /><span class="blog-read-more"><a href="21869e3c24bf8b699ed708a59f4ea719-31.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-database.php" title="Database" rel="tag">Database</a>,<a href="tag-sql.php" title="SQL" rel="tag">SQL</a>,<a href="tag-postgresql.php" title="PostgreSQL" rel="tag">PostgreSQL</a>,<a href="tag-mysql.php" title="MySQL" rel="tag">MySQL</a>,<a href="tag-sqlite.php" title="SQLite" rel="tag">SQLite</a></p></div></div><div id="unique-entry-id-41" class="blog-entry"><h1 class="blog-entry-title"><a href="c40519cb7d7eeafad65faddfdf5c9b67-41.php" class="blog-permalink">GNAT RTS for CORTEX 20160522</a></h1><div class="blog-entry-date">2016-05-22 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-body">This release includes GNAT Ada Run Time Systems (RTSs) based on FreeRTOS (http://www.freertos.org) and targeted at boards with Cortex-M3, -M4, -M4F MCUs (<a href="http://www.arduino.org" rel="external">Arduino</a> Due, the STM32F4-series evaluation boards from <a href="http://www.st.com" rel="external">STMicroelectronics</a>.<br /><br />In this release,<br /><ul class="disc"><li>There is no longer any dependence on the STMicroelectronics'  STM32Cube package.</li><li>The support for on-chip peripherals is limited to the SVD2Ada-generated spec files. The AdaCore 'bareboard' software (currently https://github.com/AdaCore/bareboard, but a name change   is under consideration) supports the STM32 line.</li><li>Tasking no longer requires an explicit start (https://sourceforge.net/p/cortex-gnat-rts/tickets/5/).</li><li>Locking in interrupt-handling protected objects no longer inhibits all interrupts, only those of equal or lower priority (https://sourceforge.net/p/cortex-gnat-rts/tickets/18/).</li></ul><br /><a href="https://sourceforge.net/projects/cortex-gnat-rts/files/20160522/">https://sourceforge.net/projects/cortex-gnat-rts/files/20160522/</a><br /><br />From Simon Wright<br /><br /><span class="blog-read-more"><a href="c40519cb7d7eeafad65faddfdf5c9b67-41.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-rts.php" title="RTS" rel="tag">RTS</a>,<a href="tag--gnat.php" title=" GNAT" rel="tag"> GNAT</a></p></div></div><div id="unique-entry-id-30" class="blog-entry"><h1 class="blog-entry-title"><a href="38d0ac3ffb5d34a9c72ceb1882860af0-30.php" class="blog-permalink">SymExpr 1.1 released</a></h1><div class="blog-entry-date">2016-05-22 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-body">SymExpr is a generic Ada package that allow you some manipulation of "symbolic expressions."<br /><br /><a href="https://launchpad.net/symexpr/+download">https://launchpad.net/symexpr/+download</a><br /><br />From <a href="mailto:framefritti@gmail.com">Riccardo Bernardini</a><span class="blog-read-more"><a href="38d0ac3ffb5d34a9c72ceb1882860af0-30.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-regexpr.php" title="RegExpr" rel="tag">RegExpr</a></p></div></div><div id="unique-entry-id-32" class="blog-entry"><h1 class="blog-entry-title"><a href="d97d4ed384789a6e99794fe1db1645cb-32.php" class="blog-permalink">Imago 0.2 released</a></h1><div class="blog-entry-date">2016-05-01 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-body">Imago is a thin binding to DevIL - Developers' Image Library (which is a library that supports working with most image formats). <br /><br /><a href="https://github.com/darkestkhan/imago/tree/0.2">https://github.com/darkestkhan/imago/tree/0.2</a><br /><br />From <a href="mailto:darkestkhan@gmail.com">darkestkhan</a><br /><br /><span class="blog-read-more"><a href="d97d4ed384789a6e99794fe1db1645cb-32.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-image.php" title="Image" rel="tag">Image</a></p></div></div>
	</div>
