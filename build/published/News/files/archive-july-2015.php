...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:title" content="Archives for July 2015 | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/archive-july-2015.php">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Ada Forge - Home">
	<meta property="og:title" content="Archives for July 2015 | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/archive-july-2015.php"> <title>Archives for July 2015 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-headings-wrapper">
		<div class="blog-archive-month">July 2015</div>
		<div class="blog-archive-link"><a href="../index.php">Programmer's Forge for Open Source Ada Code and Tools - News</a> | <a href="archive-september-2015.php">September 2015</a> | <a href="archive-may-2015.php">May 2015</a></div>
	</div>
	
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-13" class="blog-entry"><h1 class="blog-entry-title"><a href="a5028fd379ccb7aee611e12b450c6fad-13.php" class="blog-permalink">Ada packages on Archlinux updated to GPL15</a></h1><div class="blog-entry-date">2015-07-28 Filed in: <span class="blog-entry-category"><a href="category-tool.php">Tool</a></span><span class="blog-entry-category"> | <a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-body"><span style="font:14px .AppleSystemUIFont; ">The new packages are on AUR4.<br /></span><span class="blog-read-more"><a href="a5028fd379ccb7aee611e12b450c6fad-13.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-linux.php" title="Linux" rel="tag">Linux</a></p></div></div><div id="unique-entry-id-8" class="blog-entry"><h1 class="blog-entry-title"><a href="29d84545ce729f4cfc6916a0e0411242-8.php" class="blog-permalink">Qt5Ada version 5.5.0 released</a></h1><div class="blog-entry-date">2015-07-03 Filed in: <span class="blog-entry-category"><a href="category-framework.php">Framework</a></span></div><div class="blog-entry-body"><span style="font:12px .AppleSystemUIFont; ">Qt5Ada is a Ada-2012 port to Qt5 framework (based on Qt 5.5.0 final)<br /><br />This project uses a proprietary layer. It is not completely open source. (Ref David Botton)</span><span class="blog-read-more"><a href="29d84545ce729f4cfc6916a0e0411242-8.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-qt.php" title="QT" rel="tag">QT</a></p></div></div><div id="unique-entry-id-0" class="blog-entry"><h1 class="blog-entry-title"><a href="c0f4970b82f198d94b82e96668df5180-0.php" class="blog-permalink">GNOGA v1.1a released</a></h1><div class="blog-entry-date">2015-07-03 Filed in: <span class="blog-entry-category"><a href="category-framework.php">Framework</a></span></div><div class="blog-entry-body"><span style="font-size:13px; color:#424242;">Gnoga uses modern web technologies to allow simple creation of cross platform GUIs for Ada with native or custom look and feels that perform on par to native toolsets locally and can be easily and securely remoted as web apps over the internet as well.<br /></span><br />In addition to bug fixes and vastly increased stability adds:<br /><ul class="disc"><li>Completed multimedia bindings</li><li>Easier boot file creation by just including boot.js in any html file</li><li>Direct HTTPS and Secure Websockets</li><li>HTTP polling with Ajax including fallback support (using auto.html bootfile)</li></ul><br />Download <a href="http://www.gnoga.com/gnoga-1.1a.zip" rel="external">gnoga-v1.1a.zip</a> <br />or<br /><code>git clone git://git.code.sf.net/p/gnoga/code gnoga</code>or<br /><code>git refresh ; git stash; git merge</code><br />or go to <a href="http://sourceforge.net/projects/gnoga/" rel="external">SourceForge</a><br /><br /><ul class="disc"><li>GPLv3 license with Runtime Exceptions.</li></ul>From David Botton<br /><span class="blog-read-more"><a href="c0f4970b82f198d94b82e96668df5180-0.php"> Read More…</a></span><p class="blog-entry-tags">Tags: <a href="tag-web.php" title="Web" rel="tag">Web</a>,<a href="tag-javascript.php" title="JavaScript" rel="tag">JavaScript</a></p></div></div>
	</div>
