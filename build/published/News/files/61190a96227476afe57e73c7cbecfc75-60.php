...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/61190a96227476afe57e73c7cbecfc75-60.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/61190a96227476afe57e73c7cbecfc75-60.php"> <title>GCC 12.0.1 build on Mac OS-X 10.11 El Capitan, compatible SPARK2014 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-60" class="blog-entry"><h1 class="blog-entry-title">GCC 12.0.1 build on Mac OS-X 10.11 El Capitan, compatible SPARK2014</h1><div class="blog-entry-date">2022-02-19 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-summary"><br />GNAT (FSF) ~ GCC 12.0.1 of 20220128 (only Ada, C, C++, built on Mac OS-X El Capitan, runs up to macOS 12 Monterey).<br /><br />Compilers included: Ada, C, C++.<br /><br />Available on Simon&rsquo;s <a href="https://github.com/simonjwright/distributing-gcc/releases/tag/gcc-12.0.1" target="_blank">GitHub</a><br /><br /><br /><br />SPARK2014 built against it (provers CVC4, Z3, Alt-Ergo; CVC4 requires Sierra and upwards).<br />Available on Simon&rsquo;s <a href="https://github.com/simonjwright/spark2014/releases/tag/macos-0.1" target="_blank">GitHub</a>.<br />Needs GCC 12.0.1 installed. <br /></div><div class="blog-entry-body"><br />Running the test suite on the ug* tests (the examples in the User Guide) results in one failure (aside from the missing CodePeer one) unless you build with -j2 (where 2 is less than the number of processors in your machine).<br /><br />See this <a href="https://forward-in-code.blogspot.com/2022/02/spark2014-and-fsf-gcc.html" target="_blank">note on building</a> the latter <br /><br />Tools included (all at version 22.0.0, and all with the Runtime Library Exception):<br /><br />From AdaCore on GitHub :<br /><ul class="disc"><li><a href="https://github.com/AdaCore/aunit" target="_blank" title="AUnit on GitHub">AUnit</a></li><li>GNATCOLL sub-modules :</li><ul class="dashed"><li><a href="https://github.com/AdaCore/gnatcoll-core" target="_blank" title="gnatcoll-core on GitHub">gnatcoll-core</a> </li><li><a href="https://github.com/AdaCore/gnatcoll-bindings" target="_blank" title="gnatcoll-bindings on GitHub">gnatcoll-bindings</a></li><li><a href="https://github.com/AdaCore/gnatcoll-db" target="_blank" title="gnatcoll-db on GitHub">gnatcoll-db</a> (only the SQLite backend)</li></ul><li><a href="https://github.com/AdaCore/gprbuild" target="_blank" title="gprbuild on GitHub">Gprbuild</a></li><li><a href="https://github.com/AdaCore/langkit" target="_blank" title="langkit onQitHub">Langkit</a></li><li><a href="https://github.com/AdaCore/libadalang" target="_blank" title="libadalang on GitHub">Libadalang</a></li><li><a href="https://github.com/AdaCore/libadalang-tools" target="_blank" title="libadalang-tools onGitHub">Libadalang tools</a></li><li><a href="https://github.com/AdaCore/xmlada" target="_blank" title="xmlada on GitHub">XMLAda</a></li></ul><br />&copy; Simon J. Wright<br />BSD-3-Clause License<br /><p class="blog-entry-tags">Tags: <a href="tag-spark2014.php" title="SPARK2014" rel="tag">SPARK2014</a>,<a href="tag-gcc.php" title="GCC" rel="tag">GCC</a>,<a href="tag-macos.php" title="MacOS" rel="tag">MacOS</a></p></div></div>
	</div>
