...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/d91b6cbf986c709225bf5ba8f6f30b5f-75.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/d91b6cbf986c709225bf5ba8f6f30b5f-75.php"> <title>PTC ObjectAda compiler and IDE for Windows Version 10.3 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-75" class="blog-entry"><h1 class="blog-entry-title">PTC ObjectAda compiler and IDE for Windows Version 10.3</h1><div class="blog-entry-date">2021-08-24 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-summary"><span style="color:#000000;">PTC announced the release of version 10.3 of ObjectAda for Windows and PTC ObjectAda64 for Windows Ada compiler products. <br /><br />This new release provides upgraded Ada 2012 language support compliant with the Ada Conformity Assessment Test Suite (ACATS) version 4.1V and including complete support for Annex G &ldquo;Numerics&rdquo;. <br /><br />ObjectAda for Windows and ObjectAda64 for Windows support development of native Windows 32-bit or 64-bit applications using the Microsoft Visual Studio 2017 / 2019 development tools and libraries from the Windows 10 Software Development Kit (SDK).<br /><br />Read the </span><span style="color:#000000;"><a href="https://www.ptc.com/-/media/Files/PDFs/Developer-Tools/ptc-object-ada-for-windows-release-brief.pdf" target="_blank" title="PTC ObjectAda for Windows">PTC product release brief</a></span></div><div class="blog-entry-body">Enhancements:<br /><br /><ul class="disc"><li><span style="color:#000000;">Compiler, runtime, debugger, and IDE upgrades</span></li><li><span style="color:#000000;">New Ada 2012 language support</span></li><li><span style="color:#000000;">Ada 95, Ada 2005, and Ada 2012 compiler operation modes</span></li><li><span style="color:#000000;">Windows 10 compatibility</span></li><li><span style="color:#000000;">Ada bindings to Windows APIs based on Windows 10 SDK</span></li><li><span style="color:#000000;">Development using Visual C++ 2017 / 2019 tools & Windows 10 SDK libraries</span></li><li><span style="color:#000000;">Ada Development Toolkit (ADT) Eclipse interface upgrade &ndash; now works with latest (64-bit) Eclipse versions</span></li></ul><p class="blog-entry-tags">Tags: <a href="tag-sources-editor.php" title="Sources Editor" rel="tag">Sources Editor</a>,<a href="tag-windows.php" title="Windows" rel="tag">Windows</a></p></div></div>
	</div>
