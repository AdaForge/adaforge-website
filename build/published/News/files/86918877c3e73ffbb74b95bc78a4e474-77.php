...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:title" content="GCC 12.1.0 buid on macOS 12 Monterey (x86-64) | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/86918877c3e73ffbb74b95bc78a4e474-77.php">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Ada Forge - Home">
	<meta property="og:title" content="GCC 12.1.0 buid on macOS 12 Monterey (x86-64) | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/86918877c3e73ffbb74b95bc78a4e474-77.php"> <title>GCC 12.1.0 buid on macOS 12 Monterey (x86-64) | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-77" class="blog-entry"><h1 class="blog-entry-title">GCC 12.1.0 buid on macOS 12 Monterey (x86-64)</h1><div class="blog-entry-date">2022-05-11 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-summary">GNAT (FSF) ~ GCC 12.1.0, X86_64 build.<br /><br />Compilers included: Ada, C, C++.<br /><br />Available on <a href="https://github.com/simonjwright/distributing-gcc" target="_blank" title="Distributing GNAT (FSF) on Mac systems">Simon&rsquo;s GitHub</a>, and soon through ALIRE<br /><ul class="disc"><li>See the release page  <a href="https://github.com/simonjwright/distributing-gcc/releases/tag/gcc-12.1.0-x86_64" target="_blank" title="GCC 12.1.0 x86-64">GCC 12.1.0 built on MacOS X El Capitan (10.11, Darwin 15), with Xcode 8.2.1</a></li></ul><br />Also runs on macOS versions up to at least Monterey (12, Darwin 21)<br /></div><div class="blog-entry-body"><br />Tools included (all at version 22.0.0, and all with the Runtime Library Exception):<br /><br />Full GPL:<br /><ul class="disc"><li>GDB with patch</li></ul><br />From AdaCore on GitHub :<br />GPL with the <a href="http://www.gnu.org/licenses/gcc-exception-faq.html" target="_blank" title="gcc runtime exception">Runtime Library Exception</a>:<br /><ul class="disc"><li><a href="https://github.com/AdaCore/aunit" target="_blank" title="AUnit on GitHub">AUnit</a></li><li>GNATCOLL sub-modules :</li><ul class="dashed"><li><a href="https://github.com/AdaCore/gnatcoll-core" target="_blank" title="gnatcoll-core on GitHub">gnatcoll-core</a> </li><li><a href="https://github.com/AdaCore/gnatcoll-bindings" target="_blank" title="gnatcoll-bindings on GitHub">gnatcoll-bindings</a></li><li><a href="https://github.com/AdaCore/gnatcoll-db" target="_blank" title="gnatcoll-db on GitHub">gnatcoll-db</a> (only the SQLite backend)</li></ul><li><a href="https://github.com/AdaCore/gprbuild" target="_blank" title="gprbuild on GitHub">Gprbuild</a></li><li><a href="https://github.com/AdaCore/langkit" target="_blank" title="langkit onQitHub">Langkit</a></li><li><a href="https://github.com/AdaCore/libadalang" target="_blank" title="libadalang on GitHub">Libadalang</a></li><li><a href="https://github.com/AdaCore/libadalang-tools" target="_blank" title="libadalang-tools onGitHub">Libadalang tools</a></li><li><a href="https://github.com/AdaCore/xmlada" target="_blank" title="xmlada on GitHub">XMLAda</a></li></ul><br /><br />&copy; Simon J. Wright<br />BSD-3-Clause License<br /><p class="blog-entry-tags">Tags: <a href="tag-gcc.php" title="GCC" rel="tag">GCC</a>,<a href="tag-macos.php" title="MacOS" rel="tag">MacOS</a></p></div></div>
	</div>
