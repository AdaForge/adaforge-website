...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/c273ceb441f649b134fb8e319e8cc260-21.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/c273ceb441f649b134fb8e319e8cc260-21.php"> <title>A-stream-tools-1.0.4 released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-21" class="blog-entry"><h1 class="blog-entry-title">A-stream-tools-1.0.4 released</h1><div class="blog-entry-date">2016-02-29 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">Buffered, Memory and Time stream handling.<br /><br />New in this release:<br /><ul class="disc"><li>Added send_socket for better integration with gnat_socket.</li><li>Added the capability to read all the remaining elements in the stream without getting End_Error.</li></ul><br />see at https://github.com/persan/a-stream-tools/releases/tag/a-stream-tools-1.0.4-2016-02-29<br />Copyleft license.<br /><br />From Per Sandberg<br /></div><div class="blog-entry-body"><p class="blog-entry-tags">Tags: <a href="tag-streams.php" title="Streams" rel="tag">Streams</a></p></div></div>
	</div>
