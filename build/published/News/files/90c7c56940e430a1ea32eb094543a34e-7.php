...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/90c7c56940e430a1ea32eb094543a34e-7.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/90c7c56940e430a1ea32eb094543a34e-7.php"> <title>AdaControl v1.17r3 released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-7" class="blog-entry"><h1 class="blog-entry-title">AdaControl v1.17r3 released</h1><div class="blog-entry-date">2015-11-06 Filed in: <span class="blog-entry-category"><a href="category-tool.php">Tool</a></span></div><div class="blog-entry-summary">AdaControl is a free (GMGPL) tool that detects the use of various kinds of constructs in Ada programs. <br />Its first goal is to control proper usage of style or programming rules<br /><br />This version gives better support of Ada 2005/2012 constructs... especially in the handling of anonymous subtypes.<br /></div><div class="blog-entry-body"><br />Initial development of&nbsp;AdaControl was sponsored by Eurocontrol. Some rules were sponsored by BelgoControl, Alstom-Transport, Ansaldo-STS (prev. CSEE-Transport), and SAGEM-DS. It is a mature tool, routinely used to check Ada codes at Eurocontrol (Brussels, more than 2_000_000 SLOC, Maastricht), BelgoControl, Alstom, Ansaldo-STS, Faiveley, SAGEM-DS (level DO178B/A)... It has also been run against all executable tests from the ACATS.<br /><br />AdaControl is an ASIS application.<br /><br />It can be downloaded from the <a href="http://www.adalog.fr/en/adacontrol.html" rel="external">AdaControl</a> page on the http://www.adalog.fr site.<p class="blog-entry-tags">Tags: <a href="tag-ada-style.php" title="Ada Style" rel="tag">Ada Style</a>,<a href="tag-quality-code.php" title="Quality Code" rel="tag">Quality Code</a></p></div></div>
	</div>
