...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/e6a1f2864fb2f2f4ee4d6b6165c3ca90-53.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/e6a1f2864fb2f2f4ee4d6b6165c3ca90-53.php"> <title>GCC 12.0.1 buid on macOS 12 Monterey (M1) | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-53" class="blog-entry"><h1 class="blog-entry-title">GCC 12.0.1 buid on macOS 12 Monterey (M1)</h1><div class="blog-entry-date">2022-04-01 Filed in: <span class="blog-entry-category"><a href="category-compiler.php">Compiler</a></span></div><div class="blog-entry-summary">GNAT (FSF) ~ GCC 12.0.1 <br /><br />Compilers included: Ada, C, C++.<br /><br />Available on <a href="https://github.com/simonjwright/distributing-gcc" target="_blank" title="Distributing GNAT (FSF) on Mac systems">Simon&rsquo;s GitHub</a>, and soon through ALIRE<br /><ul class="disc"><li>Build for Mac M1 : <a href="https://github.com/simonjwright/distributing-gcc/releases/tag/aarch64-apple-darwin21-2" target="_blank" title="GCC 12.0.1 aarch64-apple-darwin21">GCC 12.0.1-aarch64 built on macOS Monterey (12, Darwin 21)</a></li></ul><br />Unlike previous GCC packages for macOS, <strong>this package installs at a fixed location</strong>:<br /><blockquote><p>/opt/gcc-12.0.1-aarch64</p></blockquote><br /></div><div class="blog-entry-body"><br />Tools included (all at version 22.0.0 and with the Runtime Library Exception):<br /><br />From AdaCore on GitHub :<br /><ul class="disc"><li><a href="https://github.com/AdaCore/aunit" target="_blank" title="AUnit on GitHub">AUnit</a></li><li>GNATCOLL sub-modules :</li><ul class="dashed"><li><a href="https://github.com/AdaCore/gnatcoll-core" target="_blank" title="gnatcoll-core on GitHub">gnatcoll-core</a> </li><ul class="dashed"><li>ZLIB is included, </li><li>OMP and LZMA are not (the GNATCOLL version for LZMA requires thread support in the system library, not available on macOS).</li></ul><li><a href="https://github.com/AdaCore/gnatcoll-bindings" target="_blank" title="gnatcoll-bindings on GitHub">gnatcoll-bindings</a></li><li><a href="https://github.com/AdaCore/gnatcoll-db" target="_blank" title="gnatcoll-db on GitHub">gnatcoll-db</a> (only the SQLite backend)</li></ul><li><a href="https://github.com/AdaCore/gprbuild" target="_blank" title="gprbuild on GitHub">Gprbuild</a></li></ul><ul class="disc"><li><a href="https://github.com/AdaCore/gprconfig_kb" target="_blank" title="gprconfig_kb on GitHub">Gprconfig_kb</a> with <a href="https://github.com/AdaCore/gprconfig_kb/pull/17" target="_blank" title="Patch on GitHub">this patch</a>.</li></ul><ul class="disc"><li><a href="https://github.com/AdaCore/langkit" target="_blank" title="langkit onQitHub">Langkit</a></li><li><a href="https://github.com/AdaCore/libadalang" target="_blank" title="libadalang on GitHub">Libadalang</a></li><li><a href="https://github.com/AdaCore/libadalang-tools" target="_blank" title="libadalang-tools onGitHub">Libadalang tools</a></li><li><a href="https://github.com/AdaCore/xmlada" target="_blank" title="xmlada on GitHub">XMLAda</a></li></ul><br /><br /><br />&copy; Simon J. Wright<br />BSD-3-Clause License<br /><p class="blog-entry-tags">Tags: <a href="tag-gcc.php" title="GCC" rel="tag">GCC</a>,<a href="tag-macos.php" title="MacOS" rel="tag">MacOS</a></p></div></div>
	</div>
