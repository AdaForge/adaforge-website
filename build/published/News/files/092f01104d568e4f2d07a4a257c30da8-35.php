...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/092f01104d568e4f2d07a4a257c30da8-35.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/092f01104d568e4f2d07a4a257c30da8-35.php"> <title>GLOBE_3D Release 2016-07-05 - "Blender edition" | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-35" class="blog-entry"><h1 class="blog-entry-title">GLOBE_3D Release 2016-07-05 - "Blender edition"</h1><div class="blog-entry-date">2016-07-09 Filed in: <span class="blog-entry-category"><a href="category-library.php">Library</a></span></div><div class="blog-entry-summary">GLOBE_3D is a GL Object Based 3D engine realized with the Ada programming language. <br /><br />Latest additions:<br /><ul class="disc"><li>Use of Generic Image Decoder (GID) in GL.IO; now most image formats are supported for textures and other bitmaps to be used with GLOBE_3D (or any GL app)</li><li>New Wavefront format (.obj / .mtl) importer</li><li>Doom 3 / Quake 4 map importer more complete</li><li>Unified GNAT project file (.gpr), allowing to selected the target Operating System (Windows, Linux, Mac) and compilation mode (fast, debug, small) for demos, tools, etc.</li><li>Project file for ObjectAda 9.1+ updated</li></ul><br /><a href="http://globe3d.sf.net">http://globe3d.sf.net</a> <br /><br />From:	<a href="mailto:gautier_niouzes@hotmail.com">gauthier</a><br />￼<br /></div><div class="blog-entry-body">The first two points facilitate the import of 3D models from software such as Blender.<br /><br />Here is an example: <a href="http://globe3d.sf.net/g3d/futj.jpg">http://globe3d.sf.net/g3d/futj.jpg</a><br /><br />Coincidentally, the Wavefront file format is so simple that you can also write 3D models "by hand" in that format.<br /><br />An example made in an Excel sheet is provided along with the importer, in the ./tools/wavefront directory.<br /><br />Enjoy!<br />Gautier's Ada programming<br /><a href="http://gautiersblog.blogspot.com/search/label/Ada">http://gautiersblog.blogspot.com/search/label/Ada</a><br /><p class="blog-entry-tags">Tags: <a href="tag-3d.php" title="3D" rel="tag">3D</a></p></div></div>
	</div>
