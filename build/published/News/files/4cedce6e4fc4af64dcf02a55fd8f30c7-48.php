...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/4cedce6e4fc4af64dcf02a55fd8f30c7-48.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/4cedce6e4fc4af64dcf02a55fd8f30c7-48.php"> <title>AdaControl 1.18r9 released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-48" class="blog-entry"><h1 class="blog-entry-title">AdaControl 1.18r9 released</h1><div class="blog-entry-date">2016-11-03 Filed in: <span class="blog-entry-category"><a href="category-tool.php">Tool</a></span></div><div class="blog-entry-summary">AdaControl is a free (GMGPL) tool that detects the use of various kinds of constructs in Ada programs.<br /><br />Its first goal is to control proper usage of style or programming rules, but it can also be used as a powerful tool to search for use (or non-use) of various forms of programming styles or design patterns.<br /><br />Searched elements range from very simple, like the occurrence of certaine entities, declarations, or statements, to very sophisticated, like verifying that certain programming patterns are being obeyed.<br /><br />AdaControl consist of  68 rules and 532 sub-rules!<br /><br />New : <br /><ul class="disc"><li>AdaControl accepts .gpr fichiers</li><li>Binary is precompiled for Gnat-GPL2016.</li></ul><br /><a href="http://www.adalog.fr/fr/adacontrol.html">http://www.adalog.fr/fr/adacontrol.html</a><br /><br /><br />Enjoy!<br />Jean-Pierre Rosen</div><div class="blog-entry-body"><p class="blog-entry-tags">Tags: <a href="tag-ada-style.php" title="Ada Style" rel="tag">Ada Style</a>,<a href="tag-quality-code.php" title="Quality Code" rel="tag">Quality Code</a></p></div></div>
	</div>
