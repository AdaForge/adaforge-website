...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/0b5415722f88dede9b122c15edb57991-4.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/0b5415722f88dede9b122c15edb57991-4.php"> <title>Web-application server with Servlet API | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-4" class="blog-entry"><h1 class="blog-entry-title">Web-application server with Servlet API</h1><div class="blog-entry-date">2015-01-22 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">Development version of <a href="http://forge.ada-ru.org/matreshka" rel="external">Matreshka</a> provides server-independent implementation of well known <a href="http://forge.ada-ru.org/matreshka/wiki/Web/Servlet" rel="external">Servlet</a> API and web-application server <a href="http://forge.ada-ru.org/matreshka/wiki/Web/Spikedog" rel="external">Spikedog</a> to execute Ada applications build on top of this API.<br /></div><div class="blog-entry-body"><p class="blog-entry-tags">Tags: <a href="tag-web.php" title="Web" rel="tag">Web</a></p></div></div>
	</div>
