...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:title" content="Archives for October 2016 | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/archive-october-2016.php">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Ada Forge - Home">
	<meta property="og:title" content="Archives for October 2016 | Programmer's Forge for Open Source Ada Code and Tools - News">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/archive-october-2016.php"> <title>Archives for October 2016 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-headings-wrapper">
		<div class="blog-archive-month">October 2016</div>
		<div class="blog-archive-link"><a href="../index.php">Programmer's Forge for Open Source Ada Code and Tools - News</a> | <a href="archive-november-2016.php">November 2016</a> | <a href="archive-august-2016.php">August 2016</a></div>
	</div>
	
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-49" class="blog-entry"><h1 class="blog-entry-title"><a href="2a3883c2faf8ba39f35b95261fd71947-49.php" class="blog-permalink">AdaSubst & AdaDep released</a></h1><div class="blog-entry-date">2016-10-18 Filed in: <span class="blog-entry-category"><a href="category-tool.php">Tool</a></span></div><div class="blog-entry-body"><h3>AdaDep</h3>An <a href="http://www.acm.org/sigs/sigada/WG/asiswg/" rel="external">ASIS</a>-based application to help you understand what uses what in your projects; very useful in reorganizing packages. AdaDep tells, for each package used by a module, which elements from the package are actually used<br /><br /><h3>AdaSubst</h3>An <a href="http://www.acm.org/sigs/sigada/WG/asiswg/" rel="external">ASIS</a>-based applications to help you reorganize your projects. AdaSubst performs semantic substitutions, i.e. substitutions that take Ada rules into account. With AdaSubst, you can change an identifier, or move elements from a package to another one, and change automatically all previous modules to account for the change. AdaSubst also offers functions for removing use clauses (and fixing all identifiers accordingly) and removing representation clauses.<br /><br /><br /><a href="http://www.adalog.fr/en/components.html">http://www.adalog.fr/en/components.html</a><br /><br />From Jean-Pierre Rosen<br /><span class="blog-read-more"><a href="2a3883c2faf8ba39f35b95261fd71947-49.php"> Read More…</a></span></div></div><div id="unique-entry-id-25" class="blog-entry"><h1 class="blog-entry-title"><a href="5009bd9639cfa7641c70c234e01fbd96-25.php" class="blog-permalink">Zip-Ada v.52 released</a></h1><div class="blog-entry-date">2016-10-08 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-body">Changes in '52', 08-Oct-2016:<br /><ul class="disc"><li>UnZip.Streams: all procedures have an additional (optional) <code>Ignore_Directory parameter</code>.</li><li>Zip.Compress has the following new methods with improved compression:</li></ul><ul class="dashed"><li>LZMA_3, Preselection_1 (replaces Preselection), Preselection_2.</li><li>Preselection methods use now entry name extension and size for improving compression, while remaining 1-pass methods. </li></ul><br /><a href="http://gautiersblog.blogspot.com/search/label/Ada">http://gautiersblog.blogspot.com/search/label/Ada</a> <br /><br />From Gautier<br /><span class="blog-read-more"><a href="5009bd9639cfa7641c70c234e01fbd96-25.php"> Read More…</a></span></div></div><div id="unique-entry-id-28" class="blog-entry"><h1 class="blog-entry-title"><a href="41ab411ee45f251949716e78f04b58e6-28.php" class="blog-permalink">Thick bindings for the Linux joystick API</a></h1><div class="blog-entry-date">2016-10-03 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-body">Thick bindings for the Linux joystick API are available at: <a href="https://github.com/alkhimey/Ada_Joystick">https://github.com/alkhimey/Ada_Joystick</a> <br /><br />From <a href="mailto:artium@nihamkin.com">Artium</a><br /><br /><span class="blog-read-more"><a href="41ab411ee45f251949716e78f04b58e6-28.php"> Read More…</a></span></div></div>
	</div>
