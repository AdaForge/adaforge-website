...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/0e4c46953c19379062172e129efd8416-58.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/0e4c46953c19379062172e129efd8416-58.php"> <title>Adare_net Ada network lib v0.0.21 | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-58" class="blog-entry"><h1 class="blog-entry-title">Adare_net Ada network lib v0.0.21</h1><div class="blog-entry-date">2021-09-05 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary">Adare_net is a small, portable and easy to use Ada network lib. <br />It supports ipv4 ipv6 udp and tcp, and can 'listen' with ipv6, too. <br />Socket Synchronous I/O Multiplexing is fully usable and going to be a stable API.<br /><br />The powerfull buffer feature can support all Ada types, and with a more refined treatment, you can use endian proof records and unconstrained arrays. <br /><br />This is a work in progress, but the API is already in a resonable stable state, and most changes are or new subprograms and packages or just changing internal parts without changing the visible API.<br /><br />Project on <a href="https://gitlab.com/daresoft/network/adare_net " target="_blank">GitLab</a><br /></div><div class="blog-entry-body">From now, tested and working: <br /><ul class="disc"><li>AMD64 : </li><ul class="dashed"><li>Windows 7 sp1 64bits </li><li>Ubuntu Hirsute 64bits </li></ul></ul><br />&copy; Daniel Norte Moraes<br /><p class="blog-entry-tags">Tags: <a href="tag-network.php" title="Network" rel="tag">Network</a></p></div></div>
	</div>
