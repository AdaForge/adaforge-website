...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/375eef2f7cb297bece84c6a0ea0a649d-2.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/375eef2f7cb297bece84c6a0ea0a649d-2.php"> <title>Matreshka 0.7.0 Released | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-2" class="blog-entry"><h1 class="blog-entry-title">Matreshka 0.7.0 Released</h1><div class="blog-entry-date">2015-05-22 Filed in: <span class="blog-entry-category"><a href="category-framework.php">Framework</a></span></div><div class="blog-entry-summary">We are pleased to announce new major release of <a href="http://forge.ada-ru.org/matreshka" rel="external">Matreshka</a>. See <a href="http://forge.ada-ru.org/matreshka/wiki/ReleaseNotes/0.7" rel="external">Release Notes</a> for more information and visit <a href="http://forge.ada-ru.org/matreshka/wiki/Download" rel="external">Download</a> to download source code and binary packages.<br /></div><div class="blog-entry-body"><p class="blog-entry-tags">Tags: <a href="tag-database.php" title="Database" rel="tag">Database</a>,<a href="tag-sql.php" title="SQL" rel="tag">SQL</a></p></div></div>
	</div>
