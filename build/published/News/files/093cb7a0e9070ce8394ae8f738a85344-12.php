...
<link rel="icon" type="image/png" href="https://www.adaforge.org/resources/favicon_small.png" sizes="16x16" />
	...
	<meta name="twitter:url" content="https:/www.adaforge.org/News/files/093cb7a0e9070ce8394ae8f738a85344-12.php">
	...
	<meta property="og:url" content="https:/www.adaforge.org/News/files/093cb7a0e9070ce8394ae8f738a85344-12.php"> <title>ZanyBlue v1.2.1 Beta Available | Programmer's Forge for Open Source Ada Code and Tools - News</title>
...
<body>
	...
	<div class="blog-archive-entries-wrapper">
		<div id="unique-entry-id-12" class="blog-entry"><h1 class="blog-entry-title">ZanyBlue v1.2.1 Beta Available</h1><div class="blog-entry-date">2015-09-13 Filed in: <span class="blog-entry-category"><a href="category-tech-library.php">Tech Library</a></span></div><div class="blog-entry-summary"><span style="font:14px .AppleSystemUIFont; ">This is an Ada library currently targeting localization support for Ada (along the lines of Java properties) with supporting message formatting and built-in localization for about 20 locales. <br /><br />The properties files are compiled into Ada sources built with your application and use to access application messages at run-time.<br /><br />The run-time locale is used to select localized messages, if they are available.<br /><br /></span><span style="font:14px .AppleSystemUIFont; "><a href="http://zanyblue.sourceforge.net" rel="external">http://zanyblue.sourceforge.net</a></span><span style="font:14px .AppleSystemUIFont; "><br /></span></div><div class="blog-entry-body"><span style="font:14px .AppleSystemUIFont; ">The changes for this release are :<br /></span><ul class="disc"><li><span style="font:14px .AppleSystemUIFont; ">Updates for building with GNAT 2015 (major driver for this release).</span></li><li><span style="font:14px .AppleSystemUIFont; ">Updated CLDR to release 26 from release 24.</span></li></ul><span style="font:14px .AppleSystemUIFont; "><br />Please see the the project page on Source Forge for download links, documentation, etc,<br /><br /><br />This project is licensed under a simple BSD style license.<br /><br /><br />Michael Rohan.</span><p class="blog-entry-tags">Tags: <a href="tag-localization.php" title="localization" rel="tag">localization</a>,<a href="tag-l10n.php" title="l10n" rel="tag">l10n</a>,<a href="tag-globalization.php" title="Globalization" rel="tag">Globalization</a>,<a href="tag-g11n.php" title="g11n" rel="tag">g11n</a></p></div></div>
	</div>
